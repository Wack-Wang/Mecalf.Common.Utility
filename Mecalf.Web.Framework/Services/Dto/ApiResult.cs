...
//    /// 分页的Api结果返回
//    /// </summary>
//    public class PagedApiResult<TData> : ApiResult<List<TData>>
//    {
//        /// <summary>
//        /// 默认的构造方法,不初始化任何信息
//        /// </summary>
...
//        /// </summary>
//        public PagedApiResult(bool success = true, List<TData> data = default(List<TData>))
//        {
//            Success = success;
//            Data = data;
//        }
...
//        /// 构造方法,默认Success为True,Data为空
//        /// </summary>
//        public PagedApiResult(bool success = true, List<TData> data = default(List<TData>), string msg = "")
//        {
//            Success = success;
//            Data = data;
//            Msg = msg;
...
//        /// <returns></returns>
//        public static PagedApiResult<T> Succeed<T>(int total, List<T> data = default(List<T>))
//        {
//            return new PagedApiResult<T>(true, data) { TotalCount = total };
//        }
...
//        /// <param name="data">返回的数据</param>
//        /// <returns></returns>
//        public static PagedApiResult<T> Failed<T>(string msg = "", List<T> data = default(List<T>))
//        {
